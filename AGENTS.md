...
- **BGM**: 和弦风格正弦波（频率根据故事类型调整：励志440Hz/亲情392Hz/感悟330Hz/治愈262Hz），音量15%
- **旁白女声**: 励志故事用励志女声(zh_female_jitangnv_saturn_bigtts)，亲情/治愈用温柔女声(zh_female_santongyongns_saturn_bigtts)
