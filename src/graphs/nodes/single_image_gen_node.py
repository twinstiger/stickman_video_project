...
# 固定正向绘图提示词（全局通用）- 彩色漫画风格，完整人物形象
POSITIVE_PROMPT_TEMPLATE = """【彩色插画】全彩漫画分镜，鲜艳色彩，彩色插画风格，完整漫画人物形象，9:16竖屏抖音短视频分镜，彩色漫画风格，专业插画师级手绘艺术，电影级分镜构图，高质量叙事漫画，饱满色彩，丰富层次。

【核心画面构成】
- 主角人物：完整的人物形象（有头有身体有手脚），清晰的人物轮廓，精致的面部五官表情，动态姿态有张力，服饰有鲜艳颜色，位置突出在画面焦点
- 配角人物：如有互动场景，配角形象完整（有头有身体有手脚），与主角呼应，姿态协调，形成人物关系张力
- 完整场景构建：绝不是空白背景，必须有具体场景空间，场景元素丰富且色彩多样

【人物设计】强制完整人物形象！不是火柴人！
- 完整漫画人物：人物有完整的头、身体、四肢（不是火柴人！），漫画风格但不极简
- 面部五官：眼睛、眉毛、嘴巴、鼻子都有，能传递情绪，表情生动
- 身体结构：有肩膀、手臂、躯干、腿部，比例协调，不是一根棍子
- 服饰设计：衣服褶皱、颜色搭配鲜艳、款式细节丰富
- 手脚细节：有完整的手掌手指、鞋子款式、肢体比例协调
- 头发设计：发型轮廓、发丝走向、颜色深浅

【场景细节要求】（根据剧情自动匹配）
室内场景深度细节：
- 建筑结构：墙壁有颜色、砖缝线条、门窗框架彩色、楼梯台阶、天花板横梁
- 家具陈设：桌椅沙发床柜有颜色、书架排列、茶具餐具彩色、台灯吊灯、地毯纹样
- 生活道具：书籍堆叠、杯瓶摆放彩色、衣物悬挂、照片海报、钟表电器
- 光影氛围：窗户投射的光线暖色、灯具散发的光晕、墙面的明暗过渡

室外场景深度细节：
- 城市街道：建筑立面颜色多样鲜艳、招牌霓虹彩色、门窗橱窗、路灯柱子、车辆行人
- 自然风景：树木绿叶、草地花朵彩色、远山轮廓、河流水面、天空云朵彩色
- 天气氛围：阳光穿透金黄色、雨滴落下、风吹草动、暮色晨光橙红色、月夜星光
- 空间透视：道路延伸、建筑远近、人物大小比例、透视线条正确

【色彩系统】强制彩色！
- 主色调：根据剧情情绪选择（温暖橙色系/冷静蓝色系/治愈绿色系/励志红色系），必须有颜色
- 人物颜色：服饰有鲜艳颜色区分，肤色自然柔和温暖，头发颜色多样
- 场景颜色：背景有层次色彩，道具颜色丰富鲜艳但不杂乱
- 光影颜色：光源颜色（暖光/冷光），阴影颜色深浅变化
- 色彩和谐：整体色调统一鲜艳，不出现突兀的颜色冲突，禁止黑白
...
【质量标准】
- 高清画质：线条清晰色彩饱满鲜艳，无模糊噪点，印刷级画质
- 专业构图：符合漫画分镜规范，可直接用于商业出版
- 细节丰富：画面元素不少于20个，色彩层次分明
- 故事完整：单张画面就能传达完整剧情片段
- 画风统一：彩色漫画风格，全程保持一致

禁止：空白背景、火柴人、极简火柴人、火柴人风格、棍子人、单线人物、无身体人物、黑白单色画面、黑白线条、无场景道具、真人照片、文字水印、过度卡通萌化、3D渲染、过度黑暗、杂乱无章、黑白漫画、纯黑白。

风格：彩色叙事漫画，完整漫画人物形象（有头有身体有四肢），手绘治愈风格，电影分镜质感，专业插画师水准，鲜艳色彩。
内容：根据以下剧情创作完整彩色分镜画面（人物必须有完整的头、身体、四肢，不是火柴人） - {sentence}"""

# 固定负面提示词（强制避雷）- 强调禁止火柴人
NEGATIVE_PROMPT = """火柴人，极简火柴人，火柴人风格，火柴人形象，单线火柴人，棍子人，一根棍子人物，无身体人物，无四肢人物，空白白色背景，单一场景无细节，黑白单色画面，真人照片写实，过度卡通萌系，3D渲染，照片写实，水印，画面自带文字标题，杂乱无章，夸张特效滤镜，低清模糊噪点，写实人物照片，动漫美型过度，过度阴影黑暗，线条过于简单，人物无五官表情，无头无身体，极简线条人"""
